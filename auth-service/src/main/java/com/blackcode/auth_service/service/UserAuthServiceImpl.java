...
public class UserAuthServiceImpl implements UserAuthService{
    ...
    @Override
    public JwtRes login(LoginReq loginRequest) {
    ...
    @Transactional
    @Override
    public MessageRes registration(RegistrationReq signUpReq) {
    ...
    public TokenRefreshRes refreshToken(TokenRefreshReq request) {
        ...
        if(refreshToken.isPresent()){
            ...
            User userAuth = refreshToken1.getUserAuth();

            UserAuthDetailsImpl userAuthDetails = UserAuthDetailsImpl.build(userAuth);

            String token = jwtUtils.generateJwtTokenUserAuth(userAuthDetails);
